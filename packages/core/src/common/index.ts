...
import { AppConfig, BiliConfig, AccountConfig, LiveConfig, UserDynamicConfig, ApiConfig, WebConfig } from "./config";

export interface GlobalVariables {
  version: string;
}

export class GlobalVariablesManager<T extends Record<string, any>> {
